  ...
  waxing: {
    ...
    content: {
      zh: {
        ...
        process: {
          eyebrow: 'THE PROCESS', title: '服務流程', body: ['一般會先確認服務部位、肌膚近況與妳在意的事項，再進行必要準備與除毛。服務者應在過程中說明下一個步驟，並尊重妳提出暫停或調整的需要。', '實際流程、使用方式與所需時間屬於工作室營運資訊，待真實資料確認後再補充。'],
        },
        preparation: {
        ...
        closing: { eyebrow: 'READY WHEN YOU ARE', title: '先了解，再決定', body: '如果是第一次，也可以先整理妳在意的部位與問題。正式預約管道將在真實商業資訊確認後提供。' },
      },
      en: {
        ...
        process: { eyebrow: 'THE PROCESS', title: 'What to expect', body: ['A service would generally begin by confirming the area, your current skin condition, and anything you would like the practitioner to know. Each next step should be explained, and your request to pause or adjust should be respected.', 'Exact methods, timings, and operational details will be added only when verified studio information is available.'] },
        ...
        closing: { eyebrow: 'READY WHEN YOU ARE', title: 'Understand first. Decide in your own time.', body: 'If this is your first visit, begin with the areas and questions that matter to you. A verified booking channel will be added when real business information is available.' },
      },
    },
  },
  intimateCare: {
    ...
    content: {
      zh: {
        ...
        process: { eyebrow: 'THE PROCESS', title: '尊重界線的服務方式', body: ['服務前應清楚說明照顧範圍、步驟與隱私安排，並在取得同意後進行。妳可以提出問題、表達不自在，或要求暫停。', '實際使用品項、服務時間與細部流程仍需由工作室提供真實資訊後確認。'] },
        ...
        closing: { eyebrow: 'CARE, WITHOUT JUDGMENT', title: '照顧肌膚，不需要迎合誰的標準', body: '妳可以先談談乾燥、觸感或日常保養上的困惑。正式諮詢與預約方式將在真實資訊確認後提供。' },
      },
      en: {
        ...
        process: { eyebrow: 'THE PROCESS', title: 'Care that respects boundaries', body: ['The care area, steps, and privacy arrangements should be explained before anything begins and proceed only with consent. You can ask questions, voice discomfort, or request a pause.', 'Products, timings, and detailed operational steps will only be published after the studio provides verified information.'] },
        ...
        closing: { eyebrow: 'CARE, WITHOUT JUDGMENT', title: 'Care does not need to follow anyone else’s standard.', body: 'Begin with questions about dryness, texture, or everyday care. Verified consultation and booking details will be added when available.' },
      },
    },
  },
  areolaCare: {
    ...
    content: {
      zh: {
        ...
        process: { eyebrow: 'THE PROCESS', title: '清楚說明，取得同意', body: ['這是高度重視隱私與個人界線的服務。進行前應清楚說明照顧範圍、步驟與隱私安排，並在取得同意後進行。', '實際產品、技術、服務時間與操作細節，需等待工作室提供真實資料後才能刊載。'] },
        ...
        closing: { eyebrow: 'GENTLE, INFORMED CARE', title: '妳可以按照自己的步調了解', body: '先說明在意的肌膚感受與期待，再決定是否需要保養。正式諮詢管道將在真實商業資訊確認後提供。' },
      },
      en: {
        ...
        process: { eyebrow: 'THE PROCESS', title: 'Clear explanation and consent', body: ['Privacy and personal boundaries are essential. The area, steps, and privacy arrangements should be explained clearly, and care should proceed only with consent.', 'Products, techniques, timings, and operational details will only be published when verified studio information is available.'] },
        ...
        closing: { eyebrow: 'GENTLE, INFORMED CARE', title: 'Learn at your own pace.', body: 'Begin with the skin sensations and expectations that matter to you, then decide whether care feels appropriate. A verified consultation channel will be added when available.' },
      },
    },
  },
};
