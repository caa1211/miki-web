...
| --- | --- | --- | --- | --- | --- |
| `home/hero-campaign.jpg` | Home hero; About hero | Campaign portrait | 1:1 source; displayed as a tall editorial crop | 1200 × 1200 recommended | Woman, natural skin and skincare in warm window light. Keep face and product inside the centre 70%; mobile crops vertically. Replace with real brand photography when available. |
...
| `shared/skincare-products.jpg` | Home visual break; About experience | Product / treatment detail | 3:2 | 1600 × 1067 | Neutral skincare products or real treatment preparation. On About, this is a replaceable still-life slot and must not be represented as the actual studio. |
| `shared/serum-hands.jpg` | Home philosophy detail; waxing editorial break; About philosophy | Treatment / aftercare detail | 3:2 source; displayed 3:4 or 16:9 | 1800 × 1200 | Hands applying serum in soft light. Keep the dropper and hands inside the central two-thirds. On About, replace with real hands-at-work photography when available. |
